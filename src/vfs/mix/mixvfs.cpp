 ...
 */
size_t MIXFiles::getFile(const char *fname)
{
    VFile *myvfile;
 ...
 */
void MIXFiles::releaseFile(size_t file)
{
...
Uint32 MIXFiles::readByte(size_t file, Uint8 *databuf, Uint32 numBytes)
{
    Uint32 numRead;
    Uint32 id, pos;
    MIXEntry me;
...
Uint32 MIXFiles::readWord(size_t file, Uint16 *databuf, Uint32 numWords)
{
    Uint32 numRead;
    Uint32 id, pos;
    MIXEntry me;
...
Uint32 MIXFiles::readThree(size_t file, Uint32 *databuf, Uint32 numThrees)
{
    Uint32 numRead;
    Uint32 id, pos;
    MIXEntry me;
...
Uint32 MIXFiles::readDWord(size_t file, Uint32 *databuf, Uint32 numDWords)
{
    Uint32 numRead;
    Uint32 id, pos;
    MIXEntry me;
...
char* MIXFiles::readLine(size_t file, char *databuf, Uint32 buflen)
{
    Uint32 numRead;
    Uint32 id, pos;
    MIXEntry me;
...
void MIXFiles::seekSet(size_t file, Uint32 pos)
{
...
void MIXFiles::seekCur(size_t file, Sint32 pos)
{
    openfiles[file].pos += pos;
    if( openfiles[file].pos > mixheaders[openfiles[file].id].size ) {
        openfiles[file].pos = mixheaders[openfiles[file].id].size;
...
Uint32 MIXFiles::getPos(size_t file) const
{
...
Uint32 MIXFiles::getSize(size_t file) const
{
    // @todo Abstract this const version of operator[]
...
const char* MIXFiles::getPath(size_t file) const
{
    return NULL;
}
